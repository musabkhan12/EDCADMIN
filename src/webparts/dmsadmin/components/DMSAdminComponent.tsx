               ...
               (<div>
                ...
                <div className="row manage-master mt-3">
                  {Mylistdata.map((item: any) => {
                    ...
                    const imageUrl = `https://edcadae.sharepoint.com/sites/EDeDMS/_api/v2.1/sites('${SITEID},${WEBID}')/lists('${LISTID}')/items('${itemid}')/attachments('${imageData?.fileName}')/thumbnails/0/c3000x2000/content?prefer=noredirect,closestavailablesize`;
                      ...
                      <div className="col-sm-3 col-md-3 mt-2">
                        <a href={item?.LinkUrl}>
                          <div className="card-master box1" onClick={()=>handleCreate(item.Name)}>
                            ...
                            {item.Name === "Create Entity" ? (
                              <p className="text-dark">Create Department</p>
                            ) : (
